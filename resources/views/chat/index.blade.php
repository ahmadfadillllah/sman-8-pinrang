        ...
        <div class="row g-0">
            ...
            <div class="col app-chat-contacts app-sidebar flex-grow-0 overflow-hidden border-end" id="app-chat-contacts">
                ...
                <div class="sidebar-body ps ps--active-y">
                    ...
                    <div class="ps__rail-y" style="top: 0px; height: 735px; right: 0px;">
                        <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 533px;"></div>
                    </div>
                </div>
            </div>
            <!-- /Chat contacts -->
            ...
            <div class="col app-chat-history bg-body">
                <div class="chat-history-wrapper">
                    ...
                    <div class="chat-history-body bg-body ps ps--active-y">
                        ...
                        <div class="ps__rail-x" style="left: 0px; bottom: -448px;">
                            <div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div>
                        </div>
                        <div class="ps__rail-y" style="top: 448px; height: 647px; right: 0px;">
                            <div class="ps__thumb-y" tabindex="0" style="top: 265px; height: 382px;"></div>
                        </div>
                    </div>
                    <!-- Chat message form -->
