            ...
            {{-- @if (Auth::user()->role != 'Guru') --}}
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i
                    ...
                    <ul class="menu-content">
                        ...
                        @else
                        <li class="{{ request()->is('show-nilai/lapor/siswa-name-ganjil*') ? 'active' : '' }}"><a
                            class="d-flex align-items-center" href="{{ route('show-nilai-lapor-siswa-name-ganjil', ['name' => Auth::user()->name, 'semester' => '1(Ganjil)']) }}"><i
                                data-feather="circle"></i><span class="menu-item text-truncate"
                                data-i18n="List">Lihat Raport (Ganjil)</span></a>
                        </li>
                        <li class="{{ request()->is('show-nilai/lapor/siswa-name-genap*') ? 'active' : '' }}"><a
                            class="d-flex align-items-center" href="{{ route('show-nilai-lapor-siswa-name-genap', ['name' => Auth::user()->name, 'semester' => '2(Genap)']) }}"><i
                                data-feather="circle"></i><span class="menu-item text-truncate"
                                data-i18n="List">Lihat Raport (Genap)</span></a>
                        </li>
                        @endif
                </li>
                </ul>
